...
for itr in run_list:
    lr_BO_meta_online = BayesianOptimization_meta(f=obj_func_cifar,
        ...
        log_file="results/meta_cifar_10_" + str(itr) + "_lr_1_eps_07_min_decay_07_tau_1.p", save_init=False, \
        save_init_file=None, meta_functions=meta_functions, online_learning_rate=1.0, fix_w=False, eps=0.7, ARD=True, \
        min_decay=0.7, standardize=False, use_max=False)
