...
for itr in run_list:
    lr_BO_meta_rm_gp_ts = BayesianOptimization_meta(f=obj_func_cifar, pbounds={'lr':(0, 1), 'lr_decay':(0, 1), 'l2':(0, 1)},\
              gp_opt_schedule=5, gp_model='gpy', use_init="initializations/cifar_10_init_" + str(itr) + ".p", \
              gp_mcmc=False, log_file="results/meta_cifar_10_" + str(itr) + ".p", save_init=False, \
