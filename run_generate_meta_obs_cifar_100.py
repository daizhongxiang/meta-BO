...
for itr in run_list:
    lr_BO = BayesianOptimization(f=obj_func_cifar,
            pbounds={'lr':(0, 1), 'lr_decay':(0, 1), 'l2':(0, 1)}, gp_opt_schedule=5, \
            gp_model='gpy', use_init=None, gp_mcmc=False, \
            log_file="meta_tasks/cifar_100.p", save_init=False, \
            save_init_file=None, ARD=True)
    lr_BO.maximize(n_iter=45, init_points=5, kappa=2, use_fixed_kappa=False, kappa_scale=0.2, acq='ucb')
