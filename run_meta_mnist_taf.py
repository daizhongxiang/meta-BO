...
meta_x = [meta_x[0], meta_x[1], meta_x[2]]
meta_y = [meta_y[0], meta_y[1], meta_y[2]]
...
for itr in run_list:
    BO_taf = BayesianOptimization_meta(f=obj_func_mnist,
            pbounds={'lr':(0, 1), 'lr_decay':(0, 1), 'l2':(0, 1)}, gp_opt_schedule=5, \
            gp_model='gpy', use_init="initializations/mnist_init_" + str(itr) + ".p", gp_mcmc=False, \
            log_file="results/mnist_taf_rho_05_" + str(itr) + ".p", save_init=False, \
