...
from bayesian_optimization_rgpe import BayesianOptimization_meta
...
for itr in run_list:
    BO_rgpe = BayesianOptimization_meta(f=obj_func_cifar,
            ...
            log_file="results/cifar_10_rgpe_S_500_" + str(itr) + ".p", save_init=False, \
            save_init_file=None, meta_functions=meta_functions, ARD=True, S=500)
    BO_rgpe.maximize(n_iter=25, init_points=5, kappa=3, use_fixed_kappa=False, kappa_scale=0.3, acq='ei')
